...
public class campaign_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user == null){
            ...
            //working on pulling email from the Real time data base and comparing to the AUTH Account email to verify user and display their username

//            Query checkUser = FirebaseDatabase.getInstance().getReference("User").child("username").orderByChild("email").equalTo(user.getEmail());
//
...
//                    Toast.makeText(campaign_activity.this, "something went wrong", Toast.LENGTH_SHORT).show();
//                }
//            });

            //Place holder display Email.
